...
var Args = /*#__PURE__*/function () {
  ...
  return _createClass(Args, null, [{
    ...
    value: function _class(spec) {
      return this.custom(spec, value => {
        var match = external_kolmafia_.Class.get(value);
...
var handleTypeGetError = (Type, error) => {
  ...
  if (match) {
    (0,external_kolmafia_.print)("".concat(match[0], "; if you're certain that this ").concat(Type.name, " exists and is spelled correctly, please update KoLMafia"), "red");
  } else {
 ...
 */
var $bounty = createSingleConstant(external_kolmafia_.Bounty, external_kolmafia_.toBounty);
/**
 ...
 * @category In-game constant
 */
var $class = createSingleConstant(external_kolmafia_.Class, external_kolmafia_.toClass);
/**
 ...
 * @category In-game constant
 */
var $coinmaster = createSingleConstant(external_kolmafia_.Coinmaster, external_kolmafia_.toCoinmaster);
/**
 ...
 * @category In-game constant
 */
var template_string_$effect = createSingleConstant(external_kolmafia_.Effect, external_kolmafia_.toEffect);
/**
 ...
 * @category In-game constant
 */
var $element = createSingleConstant(external_kolmafia_.Element, external_kolmafia_.toElement);
/**
 ...
 * @category In-game constant
 */
var template_string_$familiar = createSingleConstant(external_kolmafia_.Familiar, external_kolmafia_.toFamiliar);
/**
 ...
 * @category In-game constant
 */
var template_string_$item = createSingleConstant(external_kolmafia_.Item, external_kolmafia_.toItem);
/**
 ...
 * @category In-game constant
 */
var $location = createSingleConstant(external_kolmafia_.Location, external_kolmafia_.toLocation);
/**
 ...
 * @category In-game constant
 */
var $modifier = createSingleConstant(external_kolmafia_.Modifier, external_kolmafia_.toModifier);
/**
 ...
 * @category In-game constant
 */
var $modifiers = createPluralConstant(external_kolmafia_.Modifier);
/**
 * A Monster specified by name.
 *
 * @category In-game constant
 */
var $monster = createSingleConstant(external_kolmafia_.Monster, external_kolmafia_.toMonster);
/**
 ...
 * @category In-game constant
 */
var $path = createSingleConstant(external_kolmafia_.Path, external_kolmafia_.toPath);
/**
 ...
 * @category In-game constant
 */
var $phylum = createSingleConstant(external_kolmafia_.Phylum, external_kolmafia_.toPhylum);
/**
 ...
 * @category In-game constant
 */
var $servant = createSingleConstant(external_kolmafia_.Servant, external_kolmafia_.toServant);
/**
 ...
 * @category In-game constant
 */
var template_string_$skill = createSingleConstant(external_kolmafia_.Skill, external_kolmafia_.toSkill);
/**
 ...
 * @category In-game constant
 */
var $slot = createSingleConstant(external_kolmafia_.Slot, external_kolmafia_.toSlot);
/**
 ...
 * @category In-game constant
 */
var $slots = createPluralConstant(external_kolmafia_.Slot);
/**
 * A Stat specified by name.
 *
 * @category In-game constant
 */
var $stat = createSingleConstant(external_kolmafia_.Stat, external_kolmafia_.toStat);
/**
 ...
 * @category In-game constant
 */
var $thrall = createSingleConstant(external_kolmafia_.Thrall, external_kolmafia_.toThrall);
/**
...
function isSong(skillOrEffect) {
  if (skillOrEffect instanceof external_kolmafia_.Effect && skillOrEffect.attributes.includes("song")) {
    return true;
  } else {
    var skill = skillOrEffect instanceof external_kolmafia_.Effect ? (0,external_kolmafia_.toSkill)(skillOrEffect) : skillOrEffect;
...
function uneffect(effect) {
  return (0,external_kolmafia_.cliExecute)("uneffect ".concat(effect.name));
}
/**
...
function getTodaysHolidayWanderers() {
  return (0,external_kolmafia_.holiday)().split("/").flatMap(holiday => {
 ...
 */
var byStat = makeByXFunction(() => (0,external_kolmafia_.myPrimestat)().toString());
/**
 ...
 */
var byClass = makeByXFunction(() => (0,external_kolmafia_.myClass)().toString());
/**
...
function freeCrafts() {
  ...
  var all = (have($skill(_templateObject38 || (_templateObject38 = _taggedTemplateLiteral(["Rapid Prototyping"])))) ? 5 - get("_rapidPrototypingUsed") : 0) + (have($skill(_templateObject39 || (_templateObject39 = _taggedTemplateLiteral(["Expert Corner-Cutter"])))) ? 5 - get("_expertCornerCutterUsed") : 0) + effectCrafts($effect(_templateObject40 || (_templateObject40 = _taggedTemplateLiteral(["Inigo's Incantation of Inspiration"])))) + effectCrafts($effect(_templateObject41 || (_templateObject41 = _taggedTemplateLiteral(["Craft Tea"])))) + effectCrafts($effect(_templateObject42 || (_templateObject42 = _taggedTemplateLiteral(["Cooking Concentrate"]))));
...
function makeScalerCalcFunction(cache, pattern) {
  return function (monster) {
    ...
    if (current !== undefined) return (0,external_kolmafia_.monsterEval)(current);
    ...
    return (0,external_kolmafia_.monsterEval)(result);
  };
}
...
var makeBulkFunction = action => items => {
  (0,external_kolmafia_.batchOpen)();
  ...
  return (0,external_kolmafia_.batchClose)();
};
/*
 * Autosell items in bulk
 */
var bulkAutosell = makeBulkFunction(external_kolmafia_.autosell);
/*
 * Closet items in bulk
 * Note: each item transfer will still consume one request
 */
var bulkPutCloset = makeBulkFunction(external_kolmafia_.putCloset);
/*
 * Display items in bulk
 */
var bulkPutDisplay = makeBulkFunction(external_kolmafia_.putDisplay);
/*
 * Deposit items into your clan stash in bulk
 */
var bulkPutStash = makeBulkFunction(external_kolmafia_.putStash);
/*
 * Remove items from your closet in bulk
 * Note: each item transfer will still consume one request
 */
var bulkTakeCloset = makeBulkFunction(external_kolmafia_.takeCloset);
/*
 * Remove items from your display case in bulk
 */
var bulkTakeDisplay = makeBulkFunction(external_kolmafia_.takeDisplay);
/*
 * Remove items from your shop in bulk
 */
var bulkTakeShop = makeBulkFunction(external_kolmafia_.takeShop);
/*
 * Withdraw items from your clan stash in bulk
 * Note: each item transfer will still consume one request
 */
var bulkTakeStash = makeBulkFunction(external_kolmafia_.takeStash);
/*
 * Remove items from your Hagnk's in bulk
 */
var bulkTakeStorage = makeBulkFunction(external_kolmafia_.takeStorage);
/*
...
function totalFamiliarWeight() {
  ...
  return clamp(clamp(familiarWeight(familiar), have($effect(_templateObject49 || (_templateObject49 = _taggedTemplateLiteral(["Fidoxene"])))) ? 20 : 0, Infinity) + familiar.soupWeight + (considerAdjustment ? weightAdjustment() : 0) + (familiar.feasted ? 10 : 0), 1, Infinity);
}
...
var getFamiliar = createMafiaClassPropertyGetter(external_kolmafia_.Familiar, external_kolmafia_.toFamiliar, familiarNumericProperties);
var getItem = createMafiaClassPropertyGetter(external_kolmafia_.Item, external_kolmafia_.toItem, itemNumericProperties);
var getLocation = createMafiaClassPropertyGetter(external_kolmafia_.Location, external_kolmafia_.toLocation);
var getMonster = createMafiaClassPropertyGetter(external_kolmafia_.Monster, external_kolmafia_.toMonster, monsterNumericProperties);
...
function property_get(property, _default) {
  ...
  if (_default instanceof external_kolmafia_.Location) {
    ...
    return getPhylum(property, _default);
  } else if (_default instanceof external_kolmafia_.Item) {
    return getItem(property, _default);
    ...
    value: function set(propertiesToSet) {
      for (var _i2 = 0, _Object$entries2 = Object.entries(propertiesToSet); _i2 < _Object$entries2.length; _i2++) {
        ...
        if (!(propertyName in this.properties)) {
          this.properties[propertyName] = (0,external_kolmafia_.propertyExists)(propertyName) ? property_get(propertyName) : PropertiesManager.EMPTY_PREFERENCE;
        }
    ...
    value: function reset() {
      ...
      for (var _i3 = 0, _properties = properties; _i3 < _properties.length; _i3++) {
        ...
        if (value === PropertiesManager.EMPTY_PREFERENCE) {
          (0,external_kolmafia_.removeProperty)(property);
        } else {
          _set(property, value);
        }
      }
  ...
  return combat_createClass(Macro, [{
    ...
    value: function makeBALLSPredicate(condition) {
      if (condition instanceof external_kolmafia_.Monster) {
        ...
        if (condition[0] instanceof external_kolmafia_.Item) return itemOrItemsBallsMacroPredicate(condition);
      ...
      } else if (condition instanceof external_kolmafia_.Phylum) {
        return "monsterphylum ".concat(condition);
      } else if (condition instanceof external_kolmafia_.Element) {
  ...
  return dist_combat_createClass(CombatStrategy, [{
    ...
    value: function compile(resources, defaults, location, ctx) {
      ...
      if (this.starting_macro) {
        result.step.apply(result, dist_combat_toConsumableArray(this.starting_macro.map(macro => undelay(macro, ctx))));
      }
      // Perform any monster-specific macros (these may or may not end the fight)
      var monster_macros = new CompressedMacro();
      this.macros.forEach((value, key) => {
        var _Macro;
        monster_macros.add(key, (_Macro = new Macro()).step.apply(_Macro, dist_combat_toConsumableArray(value.map(macro => undelay(macro, ctx)))));
      });
      result.step(monster_macros.compile());
      // Perform the non-monster specific macro
      if (this.default_macro) result.step.apply(result, dist_combat_toConsumableArray(this.default_macro.map(macro => undelay(macro, ctx))));
    ...
    value: function compileAutoattack(ctx) {
      ...
      this.autoattacks.forEach((value, key) => {
        var _Macro2;
        monster_macros.add(key, (_Macro2 = new Macro()).step.apply(_Macro2, dist_combat_toConsumableArray(value.map(macro => undelay(macro, ctx)))));
      });
      result.step(monster_macros.compile());
      // Perform the non-monster specific macro
      if (this.default_autoattack) result.step.apply(result, dist_combat_toConsumableArray(this.default_autoattack.map(macro => undelay(macro, ctx))));
      return result;
    }
    /**
...
var CombatResources = /*#__PURE__*/function () {
  ...
  return dist_combat_createClass(CombatResources, [{
    ...
    value: function getMacro(action, ctx) {
      ...
      if (resource.do instanceof external_kolmafia_.Item) return new Macro().item(resource.do);
      if (resource.do instanceof external_kolmafia_.Skill) return new Macro().skill(resource.do);
...
var modeableState = {
  ...
  jillcandle: () => (0,external_kolmafia_.getProperty)("ledCandleMode")
};
/**
...
function canEquipItemCount() {
  var stats = $stats(maximize_templateObject9 || (maximize_templateObject9 = maximize_taggedTemplateLiteral(["Muscle, Mysticality, Moxie"]))).map(stat => Math.min((0,external_kolmafia_.myBasestat)(stat), 300));
...
function applyCached(entry, options) {
  ...
  if (outfitName) {
    ...
    if (familiarEquip) (0,external_kolmafia_.equip)($slot(maximize_templateObject11 || (maximize_templateObject11 = maximize_taggedTemplateLiteral(["familiar"]))), familiarEquip);
  } else {
  ...
  if ((0,external_kolmafia_.equippedAmount)(template_string_$item(maximize_templateObject12 || (maximize_templateObject12 = maximize_taggedTemplateLiteral(["Crown of Thrones"])))) > 0 && entry.rider.get(template_string_$item(maximize_templateObject13 || (maximize_templateObject13 = maximize_taggedTemplateLiteral(["Crown of Thrones"]))))) {
    (0,external_kolmafia_.enthroneFamiliar)(entry.rider.get(template_string_$item(maximize_templateObject14 || (maximize_templateObject14 = maximize_taggedTemplateLiteral(["Crown of Thrones"])))) || template_string_$familiar.none);
  }
  if ((0,external_kolmafia_.equippedAmount)(template_string_$item(maximize_templateObject15 || (maximize_templateObject15 = maximize_taggedTemplateLiteral(["Buddy Bjorn"])))) > 0 && entry.rider.get(template_string_$item(maximize_templateObject16 || (maximize_templateObject16 = maximize_taggedTemplateLiteral(["Buddy Bjorn"]))))) {
    (0,external_kolmafia_.bjornifyFamiliar)(entry.rider.get(template_string_$item(maximize_templateObject17 || (maximize_templateObject17 = maximize_taggedTemplateLiteral(["Buddy Bjorn"])))) || template_string_$familiar.none);
  }
...
function verifyCached(entry) {
  ...
  if ((0,external_kolmafia_.equippedAmount)(template_string_$item(maximize_templateObject25 || (maximize_templateObject25 = maximize_taggedTemplateLiteral(["Crown of Thrones"])))) > 0 && entry.rider.get(template_string_$item(maximize_templateObject26 || (maximize_templateObject26 = maximize_taggedTemplateLiteral(["Crown of Thrones"]))))) {
    if (entry.rider.get(template_string_$item(maximize_templateObject27 || (maximize_templateObject27 = maximize_taggedTemplateLiteral(["Crown of Thrones"])))) !== (0,external_kolmafia_.myEnthronedFamiliar)()) {
      if (warn) {
  ...
  if ((0,external_kolmafia_.equippedAmount)(template_string_$item(maximize_templateObject30 || (maximize_templateObject30 = maximize_taggedTemplateLiteral(["Buddy Bjorn"])))) > 0 && entry.rider.get(template_string_$item(maximize_templateObject31 || (maximize_templateObject31 = maximize_taggedTemplateLiteral(["Buddy Bjorn"]))))) {
    if (entry.rider.get(template_string_$item(maximize_templateObject32 || (maximize_templateObject32 = maximize_taggedTemplateLiteral(["Buddy Bjorn"])))) !== (0,external_kolmafia_.myBjornedFamiliar)()) {
      if (warn) {
...
function saveCached(cacheKey, options) {
  ...
  if ((0,external_kolmafia_.equippedAmount)(template_string_$item(maximize_templateObject35 || (maximize_templateObject35 = maximize_taggedTemplateLiteral(["card sleeve"])))) > 0) {
    equipment.set($slot(maximize_templateObject36 || (maximize_templateObject36 = maximize_taggedTemplateLiteral(["card-sleeve"]))), (0,external_kolmafia_.equippedItem)($slot(maximize_templateObject37 || (maximize_templateObject37 = maximize_taggedTemplateLiteral(["card-sleeve"])))));
  }
  if ((0,external_kolmafia_.equippedAmount)(template_string_$item(maximize_templateObject38 || (maximize_templateObject38 = maximize_taggedTemplateLiteral(["Crown of Thrones"])))) > 0) {
    rider.set(template_string_$item(maximize_templateObject39 || (maximize_templateObject39 = maximize_taggedTemplateLiteral(["Crown of Thrones"]))), (0,external_kolmafia_.myEnthronedFamiliar)());
  }
  if ((0,external_kolmafia_.equippedAmount)(template_string_$item(maximize_templateObject40 || (maximize_templateObject40 = maximize_taggedTemplateLiteral(["Buddy Bjorn"])))) > 0) {
    rider.set(template_string_$item(maximize_templateObject41 || (maximize_templateObject41 = maximize_taggedTemplateLiteral(["Buddy Bjorn"]))), (0,external_kolmafia_.myBjornedFamiliar)());
  }
...
var Outfit = /*#__PURE__*/function () {
  ...
  return outfit_createClass(Outfit, [{
    ...
    value: function equipNonAccessory(item, slot) {
      if ($slots(outfit_templateObject || (outfit_templateObject = outfit_taggedTemplateLiteral(["acc1, acc2, acc3"]))).includes((0,external_kolmafia_.toSlot)(item))) return false;
      ...
      switch ((0,external_kolmafia_.toSlot)(item)) {
        ...
        case $slot(outfit_templateObject5 || (outfit_templateObject5 = outfit_taggedTemplateLiteral(["familiar"]))):
          ...
          break;
        case $slot(outfit_templateObject6 || (outfit_templateObject6 = outfit_taggedTemplateLiteral(["weapon"]))):
          if (!weaponsCompatible(item, this.equips.get($slot(outfit_templateObject7 || (outfit_templateObject7 = outfit_taggedTemplateLiteral(["off-hand"])))))) return false;
          break;
      }
      if ((0,external_kolmafia_.toSlot)(item) !== $slot(outfit_templateObject8 || (outfit_templateObject8 = outfit_taggedTemplateLiteral(["familiar"]))) && !(0,external_kolmafia_.canEquip)(item)) return false;
    ...
    value: function equipAccessory(item, slot) {
      if (![undefined].concat(outfit_toConsumableArray($slots(outfit_templateObject9 || (outfit_templateObject9 = outfit_taggedTemplateLiteral(["acc1, acc2, acc3"]))))).includes(slot)) return false;
      if ((0,external_kolmafia_.toSlot)(item) !== $slot(outfit_templateObject10 || (outfit_templateObject10 = outfit_taggedTemplateLiteral(["acc1"])))) return false;
      if (!(0,external_kolmafia_.canEquip)(item)) return false;
      if (slot === undefined) {
        // We don't care which of the accessory slots we equip in
        var empty = $slots(outfit_templateObject11 || (outfit_templateObject11 = outfit_taggedTemplateLiteral(["acc1, acc2, acc3"]))).find(s => !this.equips.has(s));
    ...
    value: function equipUsingDualWield(item, slot) {
      if (![undefined, $slot(outfit_templateObject12 || (outfit_templateObject12 = outfit_taggedTemplateLiteral(["off-hand"])))].includes(slot)) return false;
      if ((0,external_kolmafia_.toSlot)(item) !== $slot(outfit_templateObject13 || (outfit_templateObject13 = outfit_taggedTemplateLiteral(["weapon"])))) return false;
      if (this.equips.has($slot(outfit_templateObject14 || (outfit_templateObject14 = outfit_taggedTemplateLiteral(["weapon"])))) && weaponHands(this.equips.get($slot(outfit_templateObject15 || (outfit_templateObject15 = outfit_taggedTemplateLiteral(["weapon"]))))) !== 1) {
        return false;
      }
      if (this.equips.has($slot(outfit_templateObject16 || (outfit_templateObject16 = outfit_taggedTemplateLiteral(["off-hand"]))))) return false;
      if (!have(template_string_$skill(outfit_templateObject17 || (outfit_templateObject17 = outfit_taggedTemplateLiteral(["Double-Fisted Skull Smashing"]))))) return false;
      if (weaponHands(item) !== 1) return false;
      if (!(0,external_kolmafia_.canEquip)(item)) return false;
      if (!weaponsCompatible(this.equips.get($slot(outfit_templateObject18 || (outfit_templateObject18 = outfit_taggedTemplateLiteral(["weapon"])))), item)) return false;
      this.equips.set($slot(outfit_templateObject19 || (outfit_templateObject19 = outfit_taggedTemplateLiteral(["off-hand"]))), item);
      return true;
    }
  }, {
    ...
    value: function getHoldingFamiliar(item) {
      switch ((0,external_kolmafia_.toSlot)(item)) {
        case $slot(outfit_templateObject20 || (outfit_templateObject20 = outfit_taggedTemplateLiteral(["weapon"]))):
          return template_string_$familiar(outfit_templateObject21 || (outfit_templateObject21 = outfit_taggedTemplateLiteral(["Disembodied Hand"])));
        case $slot(outfit_templateObject22 || (outfit_templateObject22 = outfit_taggedTemplateLiteral(["off-hand"]))):
          return template_string_$familiar(outfit_templateObject23 || (outfit_templateObject23 = outfit_taggedTemplateLiteral(["Left-Hand Man"])));
        case $slot(outfit_templateObject24 || (outfit_templateObject24 = outfit_taggedTemplateLiteral(["pants"]))):
          return template_string_$familiar(outfit_templateObject25 || (outfit_templateObject25 = outfit_taggedTemplateLiteral(["Fancypants Scarecrow"])));
        case $slot(outfit_templateObject26 || (outfit_templateObject26 = outfit_taggedTemplateLiteral(["hat"]))):
          return template_string_$familiar(outfit_templateObject27 || (outfit_templateObject27 = outfit_taggedTemplateLiteral(["Mad Hatrack"])));
        default:
          return undefined;
      }
    }
    ...
    value: function equipUsingFamiliar(item, slot) {
      if (![undefined, $slot(outfit_templateObject28 || (outfit_templateObject28 = outfit_taggedTemplateLiteral(["familiar"])))].includes(slot)) return false;
      if (this.equips.has($slot(outfit_templateObject29 || (outfit_templateObject29 = outfit_taggedTemplateLiteral(["familiar"]))))) return false;
      ...
      if (familiar === undefined || $familiars(outfit_templateObject30 || (outfit_templateObject30 = outfit_taggedTemplateLiteral(["Fancypants Scarecrow, Mad Hatrack"]))).includes(familiar) && slot === undefined) {
        return false;
      }
      if (!this.equip(familiar)) return false;
      this.equips.set($slot(outfit_templateObject31 || (outfit_templateObject31 = outfit_taggedTemplateLiteral(["familiar"]))), item);
      return true;
    }
  }, {
    key: "equipItem",
    ...
    value: function equipFamiliar(familiar) {
      ...
      var item = this.equips.get($slot(outfit_templateObject32 || (outfit_templateObject32 = outfit_taggedTemplateLiteral(["familiar"]))));
      if (item !== undefined && item !== template_string_$item.none && !(0,external_kolmafia_.canEquip)(familiar, item)) return false;
      this.familiar = familiar;
      return true;
    }
  }, {
    ...
    value: function equipSpec(spec) {
      ...
      for (var _i = 0, _outfitSlots = outfitSlots; _i < _outfitSlots.length; _i++) {
        ...
        var slot = (_a = new Map([["famequip", $slot(outfit_templateObject33 || (outfit_templateObject33 = outfit_taggedTemplateLiteral(["familiar"])))], ["offhand", $slot(outfit_templateObject34 || (outfit_templateObject34 = outfit_taggedTemplateLiteral(["off-hand"])))]]).get(slotName)) !== null && _a !== void 0 ? _a : (0,external_kolmafia_.toSlot)(slotName);
    ...
    value: function bjornify(target) {
      return this.equipRider(target, $slot(outfit_templateObject35 || (outfit_templateObject35 = outfit_taggedTemplateLiteral(["buddy-bjorn"]))));
    }
    /**
    ...
    value: function enthrone(target) {
      return this.equipRider(target, $slot(outfit_templateObject36 || (outfit_templateObject36 = outfit_taggedTemplateLiteral(["crown-of-thrones"]))));
    }
    /**
    ...
    value: function _dress(refreshed) {
      ...
      var nonaccessorySlots = $slots(outfit_templateObject37 || (outfit_templateObject37 = outfit_taggedTemplateLiteral(["weapon, off-hand, hat, back, shirt, pants, familiar"])));
      var bjorn = this.riders.get($slot(outfit_templateObject38 || (outfit_templateObject38 = outfit_taggedTemplateLiteral(["buddy-bjorn"]))));
      if (bjorn && (this.equips.get($slot(outfit_templateObject39 || (outfit_templateObject39 = outfit_taggedTemplateLiteral(["back"])))) === template_string_$item(outfit_templateObject40 || (outfit_templateObject40 = outfit_taggedTemplateLiteral(["Buddy Bjorn"]))) || this.getBonus(template_string_$item(outfit_templateObject41 || (outfit_templateObject41 = outfit_taggedTemplateLiteral(["Buddy Bjorn"])))))) {
        usedSlots.add($slot(outfit_templateObject42 || (outfit_templateObject42 = outfit_taggedTemplateLiteral(["buddy-bjorn"]))));
        usedSlots.add($slot(outfit_templateObject43 || (outfit_templateObject43 = outfit_taggedTemplateLiteral(["crown-of-thrones"]))));
      }
      var crown = this.riders.get($slot(outfit_templateObject44 || (outfit_templateObject44 = outfit_taggedTemplateLiteral(["crown-of-thrones"]))));
      if (crown && (this.equips.get($slot(outfit_templateObject45 || (outfit_templateObject45 = outfit_taggedTemplateLiteral(["hat"])))) === template_string_$item(outfit_templateObject46 || (outfit_templateObject46 = outfit_taggedTemplateLiteral(["Crown of Thrones"]))) || this.getBonus(template_string_$item(outfit_templateObject47 || (outfit_templateObject47 = outfit_taggedTemplateLiteral(["Crown of Thrones"])))))) {
        usedSlots.add($slot(outfit_templateObject48 || (outfit_templateObject48 = outfit_taggedTemplateLiteral(["buddy-bjorn"]))));
        usedSlots.add($slot(outfit_templateObject49 || (outfit_templateObject49 = outfit_taggedTemplateLiteral(["crown-of-thrones"]))));
      }
      ...
      if (weaponHands((0,external_kolmafia_.equippedItem)($slot(outfit_templateObject50 || (outfit_templateObject50 = outfit_taggedTemplateLiteral(["weapon"]))))) !== 1 && this.equips.has($slot(outfit_templateObject51 || (outfit_templateObject51 = outfit_taggedTemplateLiteral(["offhand"])))) && !this.equips.has($slot(outfit_templateObject52 || (outfit_templateObject52 = outfit_taggedTemplateLiteral(["weapon"]))))) (0,external_kolmafia_.equip)($slot(outfit_templateObject53 || (outfit_templateObject53 = outfit_taggedTemplateLiteral(["weapon"]))), template_string_$item.none);
      // 2. An existing dual-fisted ranged weapon would block melee weapons.
      if (!weaponsCompatible(this.equips.get($slot(outfit_templateObject54 || (outfit_templateObject54 = outfit_taggedTemplateLiteral(["weapon"])))), (0,external_kolmafia_.equippedItem)($slot(outfit_templateObject55 || (outfit_templateObject55 = outfit_taggedTemplateLiteral(["off-hand"])))))) (0,external_kolmafia_.equip)($slot(_templateObject56 || (_templateObject56 = outfit_taggedTemplateLiteral(["off-hand"]))), template_string_$item.none);
      ...
      try {
        for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
          ...
          if (targetEquipment.includes((0,external_kolmafia_.equippedItem)(slot)) && this.equips.get(slot) !== (0,external_kolmafia_.equippedItem)(slot) || this.avoid.includes((0,external_kolmafia_.equippedItem)(slot))) (0,external_kolmafia_.equip)(slot, template_string_$item.none);
        }
      ...
      var accessorySlots = $slots(_templateObject57 || (_templateObject57 = outfit_taggedTemplateLiteral(["acc1, acc2, acc3"])));
      ...
      if (bjorn && (0,external_kolmafia_.haveEquipped)(template_string_$item(_templateObject58 || (_templateObject58 = outfit_taggedTemplateLiteral(["Buddy Bjorn"]))))) {
        if ((0,external_kolmafia_.myEnthronedFamiliar)() === bjorn) (0,external_kolmafia_.enthroneFamiliar)(template_string_$familiar.none);
        if ((0,external_kolmafia_.myBjornedFamiliar)() !== bjorn) (0,external_kolmafia_.bjornifyFamiliar)(bjorn);
      }
      if (crown && (0,external_kolmafia_.haveEquipped)(template_string_$item(_templateObject59 || (_templateObject59 = outfit_taggedTemplateLiteral(["Crown of Thrones"]))))) {
        if ((0,external_kolmafia_.myBjornedFamiliar)() === crown) (0,external_kolmafia_.bjornifyFamiliar)(template_string_$familiar.none);
      ...
      for (var _i4 = 0, _arr = [[$slot(_templateObject60 || (_templateObject60 = outfit_taggedTemplateLiteral(["buddy-bjorn"]))), template_string_$item(_templateObject61 || (_templateObject61 = outfit_taggedTemplateLiteral(["Buddy Bjorn"]))), external_kolmafia_.myBjornedFamiliar], [$slot(_templateObject62 || (_templateObject62 = outfit_taggedTemplateLiteral(["crown-of-thrones"]))), template_string_$item(_templateObject63 || (_templateObject63 = outfit_taggedTemplateLiteral(["Crown of Thrones"]))), external_kolmafia_.myEnthronedFamiliar]]; _i4 < _arr.length; _i4++) {
    ...
    value: function spec() {
      ...
      for (var _i5 = 0, _outfitSlots2 = outfitSlots; _i5 < _outfitSlots2.length; _i5++) {
        ...
        var entry = this.equips.get((_a = new Map([["famequip", $slot(_templateObject64 || (_templateObject64 = outfit_taggedTemplateLiteral(["familiar"])))], ["offhand", $slot(_templateObject65 || (_templateObject65 = outfit_taggedTemplateLiteral(["off-hand"])))]]).get(slotName)) !== null && _a !== void 0 ? _a : (0,external_kolmafia_.toSlot)(slotName));
        if (entry) result[slotName] = entry;
      }
      // Include the riders
      var riders = {};
      var buddyRider = this.riders.get($slot(_templateObject66 || (_templateObject66 = outfit_taggedTemplateLiteral(["buddy-bjorn"]))));
      if (buddyRider !== undefined) riders["buddy-bjorn"] = buddyRider;
      var throneRider = this.riders.get($slot(_templateObject67 || (_templateObject67 = outfit_taggedTemplateLiteral(["crown-of-thrones"]))));
    ...
    value: function current() {
      ...
      for (var _i6 = 0, _outfitSlots3 = outfitSlots; _i6 < _outfitSlots3.length; _i6++) {
        ...
        var slot = (_a = new Map([["famequip", $slot(_templateObject68 || (_templateObject68 = outfit_taggedTemplateLiteral(["familiar"])))], ["offhand", $slot(_templateObject69 || (_templateObject69 = outfit_taggedTemplateLiteral(["off-hand"])))]]).get(slotName)) !== null && _a !== void 0 ? _a : (0,external_kolmafia_.toSlot)(slotName);
      ...
      if ((0,external_kolmafia_.haveEquipped)(template_string_$item(_templateObject70 || (_templateObject70 = outfit_taggedTemplateLiteral(["Crown of Thrones"]))))) outfit.riders.set($slot(_templateObject71 || (_templateObject71 = outfit_taggedTemplateLiteral(["crown-of-thrones"]))), (0,external_kolmafia_.myEnthronedFamiliar)());
      if ((0,external_kolmafia_.haveEquipped)(template_string_$item(_templateObject72 || (_templateObject72 = outfit_taggedTemplateLiteral(["Buddy Bjorn"]))))) outfit.riders.set($slot(_templateObject73 || (_templateObject73 = outfit_taggedTemplateLiteral(["buddy-bjorn"]))), (0,external_kolmafia_.myBjornedFamiliar)());
...
function weaponsCompatible(weapon, offhand) {
  if (!weapon || weapon === template_string_$item(_templateObject74 || (_templateObject74 = outfit_taggedTemplateLiteral(["none"])))) return true;
  if (!offhand || offhand === template_string_$item(_templateObject75 || (_templateObject75 = outfit_taggedTemplateLiteral(["none"])))) return true;
  if ((0,external_kolmafia_.toSlot)(offhand) !== $slot(_templateObject76 || (_templateObject76 = outfit_taggedTemplateLiteral(["weapon"])))) return true;
  var weaponStat = (0,external_kolmafia_.weaponType)(weapon);
  var offhandStat = (0,external_kolmafia_.weaponType)(offhand);
  if (weaponStat === $stat(_templateObject77 || (_templateObject77 = outfit_taggedTemplateLiteral(["Moxie"]))) && (offhandStat === $stat(_templateObject78 || (_templateObject78 = outfit_taggedTemplateLiteral(["Mysticality"]))) || offhandStat === $stat(_templateObject79 || (_templateObject79 = outfit_taggedTemplateLiteral(["Muscle"]))))) return false;
  if (offhandStat === $stat(_templateObject80 || (_templateObject80 = outfit_taggedTemplateLiteral(["Moxie"]))) && (weaponStat === $stat(_templateObject81 || (_templateObject81 = outfit_taggedTemplateLiteral(["Mysticality"]))) || weaponStat === $stat(_templateObject82 || (_templateObject82 = outfit_taggedTemplateLiteral(["Muscle"]))))) return false;
  return true;
}
...
var ContextualEngine = /*#__PURE__*/function () {
  ...
  function ContextualEngine(tasks, options) {
    engine_classCallCheck(this, ContextualEngine);
    this.attempts = {};
   ...
   */
  return engine_createClass(ContextualEngine, [{
    key: "getNextTask",
    ...
    value: function printExecutingMessage(task) {
      ...
      (0,external_kolmafia_.print)("Executing ".concat(task.name), "blue");
    }
    /**
    ...
    value: function acquireEffects(task) {
      ...
      var extraSongs = Object.keys((0,external_kolmafia_.myEffects)()).map(effectName => (0,external_kolmafia_.toEffect)(effectName)).filter(effect => isSong(effect) && !songs.includes(effect));
    ...
    value: function setCombat(task, task_combat, task_resources) {
      ...
      var macro = task_combat.compile(task_resources, (_a = this.options) === null || _a === void 0 ? void 0 : _a.combat_defaults, task.do instanceof external_kolmafia_.Location ? task.do : undefined, this.getContext(task));
      macro.save();
      if (!this.options.ccs) {
    ...
    value: function _do(task) {
      ...
      while ((0,external_kolmafia_.inMultiFight)()) (0,external_kolmafia_.runCombat)();
...
var Engine = /*#__PURE__*/(/* unused pure expression or super */ null && (function (_ContextualEngine) {
  function Engine() {
    engine_classCallCheck(this, Engine);
    return engine_callSuper(this, Engine, arguments);
  }
  engine_inherits(Engine, _ContextualEngine);
...
var zoneSpecificNCs = new Map(Object.entries((0,external_kolmafia_.fileToBuffer)("data/encounters.txt").split("\n").reduce((obj, line) => {
  var _a;
  ...
  return engine_objectSpread(engine_objectSpread({}, obj), {}, engine_defineProperty({}, name, [].concat(engine_toConsumableArray((_a = obj[name]) !== null && _a !== void 0 ? _a : []), [(0,external_kolmafia_.toLocation)(location)])));
}, {})));
/**
...
var args = Args.create("FolgerCS", "Written by Seraphiii, branched from InstantSCCS by Pantocyclus. This is a CS-script with a focus on maximum aftercore profits", {
  version: Args.flag({
...
function relay_iterableToArrayLimit(r, l) { var t = null == r ? null : "undefined" != typeof Symbol && r[Symbol.iterator] || r["@@iterator"]; if (null != t) { var e, n, i, u, a = [], f = !0, o = !1; try { if (i = (t = t.call(r)).next, 0 === l) { if (Object(t) !== t) return; f = !1; } else for (; !(f = (e = i.call(t)).done) && (a.push(e.value), a.length !== l); f = !0); } catch (r) { o = !0, n = r; } finally { try { if (!f && null != t.return && (u = t.return(), Object(u) !== u)) return; } finally { if (o) throw n; } } return a; } }
...
function convertArgsToHtml() {
  ...
  metadata.traverse((key, name) => {
    ...
    var component = {
      ...
      default: "default" in key ? "".concat(key["default"]) : "block"
    };
