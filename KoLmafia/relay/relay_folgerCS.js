...
var Outfit = /*#__PURE__*/function () {
  ...
  outfit_createClass(Outfit, [{
    ...
    value: function _dress(refreshed) {
      ...
      if (bjorn && (0,external_kolmafia_.haveEquipped)(template_string_$item(outfit_templateObject49 || (outfit_templateObject49 = outfit_taggedTemplateLiteral(["Buddy Bjorn"]))))) {
      ...
      if (crown && (0,external_kolmafia_.haveEquipped)(template_string_$item(_templateObject50 || (_templateObject50 = outfit_taggedTemplateLiteral(["Crown of Thrones"]))))) {
    ...
    value: function spec() {
      ...
      for (var _i5 = 0, _outfitSlots2 = outfitSlots; _i5 < _outfitSlots2.length; _i5++) {
        ...
        var entry = this.equips.get((_a = new Map([["famequip", $slot(_templateObject58 || (_templateObject58 = outfit_taggedTemplateLiteral(["familiar"])))], ["offhand", $slot(_templateObject59 || (_templateObject59 = outfit_taggedTemplateLiteral(["off-hand"])))]]).get(slotName)) !== null && _a !== void 0 ? _a : (0,external_kolmafia_.toSlot)(slotName));
        if (entry) result[slotName] = entry;
      }
      // Include the riders
      var riders = {};
      var buddyRider = this.riders.get($slot(_templateObject60 || (_templateObject60 = outfit_taggedTemplateLiteral(["buddy-bjorn"]))));
      if (buddyRider !== undefined) riders["buddy-bjorn"] = buddyRider;
      var throneRider = this.riders.get($slot(_templateObject61 || (_templateObject61 = outfit_taggedTemplateLiteral(["crown-of-thrones"]))));
    ...
    value: function current() {
      ...
      for (var _i6 = 0, _outfitSlots3 = outfitSlots; _i6 < _outfitSlots3.length; _i6++) {
        ...
        var slot = (_a = new Map([["famequip", $slot(_templateObject62 || (_templateObject62 = outfit_taggedTemplateLiteral(["familiar"])))], ["offhand", $slot(_templateObject63 || (_templateObject63 = outfit_taggedTemplateLiteral(["off-hand"])))]]).get(slotName)) !== null && _a !== void 0 ? _a : (0,external_kolmafia_.toSlot)(slotName);
      ...
      if ((0,external_kolmafia_.haveEquipped)(template_string_$item(_templateObject64 || (_templateObject64 = outfit_taggedTemplateLiteral(["Crown of Thrones"]))))) outfit.riders.set($slot(_templateObject65 || (_templateObject65 = outfit_taggedTemplateLiteral(["crown-of-thrones"]))), (0,external_kolmafia_.myEnthronedFamiliar)());
      if ((0,external_kolmafia_.haveEquipped)(template_string_$item(_templateObject66 || (_templateObject66 = outfit_taggedTemplateLiteral(["Buddy Bjorn"]))))) outfit.riders.set($slot(_templateObject67 || (_templateObject67 = outfit_taggedTemplateLiteral(["buddy-bjorn"]))), (0,external_kolmafia_.myBjornedFamiliar)());
